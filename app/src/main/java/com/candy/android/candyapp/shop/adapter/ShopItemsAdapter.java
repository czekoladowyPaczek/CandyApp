...
public class ShopItemsAdapter extends RecyclerView.Adapter<ShopItemsAdapter.ViewHolder> {
    ...
    private List<ModelShopItem> shops;
    private TextDrawable.IBuilder drawableBuilder = TextDrawable.builder().round();
    private ColorGenerator colorGenerator = ColorGenerator.MATERIAL;
    private LayoutInflater inflater;
    private OnItemClickListener onClick;

    public ShopItemsAdapter(Context context, List<ModelShopItem> shops, OnItemClickListener onClick) {
        this.shops = shops;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(ModelShopItem shop, Drawable drawable) {
            image.setImageDrawable(drawable);
            name.setText(shop.getName());
            creator.setText(shop.getCount() + " " + shop.getMetric());
        }
    }
}
